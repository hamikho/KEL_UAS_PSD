...
def run():
    st.title("Soal 4")
    st.write("Analisis banyak penyewa per minggu, bulan, dan harimenggunakan histogram dan grafik - 10123181 - Muhamad Dzaky Abdullah")  
    st.title("Analisis Penyewaan Sepeda")

    # Mengambil dataset yang sudah dibersihkan dari home.py
    day = home.DATA_DAY
    
    # Konversi tanggal dan ekstrak informasi
